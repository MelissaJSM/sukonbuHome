...
public class LAppView {
    ...
    // 画像を初期化する
    public void initializeSprite() { // 여기가 배경설정하는곳이 맞는데...
        ...
        System.out.println("가져오는 경로 값 한번 보자 : " + ResourcePath.ROOT.getPath() + ResourcePath.BACK_IMAGE.getPath());
        ...
        float fWidth = backgroundTexture.width * 1.0f;
