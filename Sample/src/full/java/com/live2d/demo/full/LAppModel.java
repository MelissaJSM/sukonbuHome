...
//         前回セーブされた状態をロード
    ...
    public int startMotion(final String group,
        ...
        // load sound files 사운드 파일 소환하는게 있네??
        ...
        if (debugMode) {
            System.out.println("group : " + group + " ///// number : " + number + " ///// priority : " + priority + " ///// onFinishedMotionHandler : " + onFinishedMotionHandler);
    ...
    public int startRandomMotioning(final String group, int priority, IFinishedMotionCallback onFinishedMotionHandler, int systemNum) {
        System.out.println("스타트 랜덤모션 진입");
        ...
        return startMotion(group, systemNum, priority, onFinishedMotionHandler);
    }

    public int startTouchMotion(final String group, int priority, IFinishedMotionCallback onFinishedMotionHandler, int systemNum) {
        System.out.println("스타트 랜덤모션 진입");
